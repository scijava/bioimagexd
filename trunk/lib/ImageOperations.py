...
def rescaleDataUnits(dataunits, rangemin, rangemax):
	"""
	Rescales dataunits to some range
	@param dataunits list of dataunits to be rescaled
	@param rangemin Minimum value of the range wanted
	@param rangemax Maximum value of the range wanted
	"""
	for dataunit in dataunits:
		...
		shift = (rangeOrig / rangediff) * rangemin - minval
		scale = rangediff / float(rangeOrig)
