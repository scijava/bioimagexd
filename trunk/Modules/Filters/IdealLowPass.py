...
# -*- coding: iso-8859-1 -*-
"""
 Unit: IdealLowPass.py
 Project: BioImageXD
 Description:

 A module that contains ideal low pass filter in fourier domain for the
 processing task.
...
class IdealLowPassFilter(FourierFilters.FourierFilter):
	"""
	An ideal low pass filter in fourier domain
	"""
	name = "Ideal low pass"
