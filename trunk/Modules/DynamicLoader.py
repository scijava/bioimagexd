...
class PluginLoader:
	def __init__(self):
		...
		self.ignore = ["Modules/Rendering/ScaleBar.py", "Modules/Rendering/Spline.py", "Modules/Rendering/ArbitrarySlicer.py", "Modules/Task/__init__.py", "Modules/Readers/BioradDataSource.py", "Modules/Filters/ExtractComponent.py", "Modules/Filters/GradientMagnitudeITK.py"]
