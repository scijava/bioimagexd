...
=========================================================================*/
// .NAME vtkExtXMLUtilities - XML utilities.
// .SECTION Description
// vtkExtXMLUtilities provides XML-related convenience functions.
// .SECTION See Also
// vtkXMLDataElement
// No changes in vtkExtXMLUtilities.h compared to original vtkXMLUtilities.h

#ifndef __vtkExtXMLUtilities_h
...
public:
  ...
  vtkTypeRevisionMacro(vtkExtXMLUtilities, vtkObject);
...
private:
  vtkExtXMLUtilities(const vtkExtXMLUtilities&); // Not implemented
  void operator=(const vtkExtXMLUtilities&); // Not implemented    
};
