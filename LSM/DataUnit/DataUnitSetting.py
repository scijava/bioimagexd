...
class ColorMergingDataUnitSetting(DataUnitSetting):
    ...
    def parseSettingsString(self,parseString):
        ...
        self.intensityTransferFunction=IntensityTransferFunction()
        ...
        if (parseString!=""):
            ...
            iLen=len(self.intensityTransferFunction.getAsParameterList())
            if (len(il)!=3+iLen):
            ...
            self.intensityTransferFunction.setFromParameterList(il[3:iLen+3])

        print "created a ColorMergingDataUnitSetting with color:",\
            self.getColor()
        print "and intensity transfer function:",\
            self.intensityTransferFunction.getAsParameterList()
