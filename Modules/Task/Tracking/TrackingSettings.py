...
class TrackingSettings(FilterBasedTaskSettings.FilterBasedTaskSettings):
    """
    Created: 27.03.2005, KP
    Description: Stores settings related to single unit Trackinging
    """
