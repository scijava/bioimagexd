...
# -*- coding: iso-8859-1 -*-
"""
 Unit: ButterworthLowPass.py
 Project: BioImageXD
 Created: 23.09.2009, LP
 Description:

 A module that contains Butterworth low pass filter in fourier domain for the
 processing task.
...
class ButterworthLowPassFilter(FourierFilters.FourierFilter):
	"""
	A Butterworth low pass filter in fourier domain
	"""
